...
class AvaliacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliacao" do
    assert_difference("Avaliacao.count") do
      post avaliacaos_url, params: { avaliacao: { aluno_id: @avaliacao.aluno_id, data: @avaliacao.data, disciplina_id: @avaliacao.disciplina_id, float: @avaliacao.float, nota: @avaliacao.nota, sala_id: @avaliacao.sala_id } }
    end
  ...
  test "should update avaliacao" do
    patch avaliacao_url(@avaliacao), params: { avaliacao: { aluno_id: @avaliacao.aluno_id, data: @avaliacao.data, disciplina_id: @avaliacao.disciplina_id, float: @avaliacao.float, nota: @avaliacao.nota, sala_id: @avaliacao.sala_id } }
