...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { cod: @aluno.cod, idade: @aluno.idade, nome: @aluno.nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { cod: @aluno.cod, idade: @aluno.idade, nome: @aluno.nome } }
